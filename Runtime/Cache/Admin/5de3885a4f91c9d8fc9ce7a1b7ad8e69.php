      ...
      <form enctype="multipart/form-data" action="<?php echo U('Admin/Goods/goodsadd');?>" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <?php if(is_array($cat)): foreach($cat as $key=>$c): ?><option value="<?php echo ($c["cat_id"]); ?>" ><?php echo (str_repeat('&nbsp',$c['lev']*2)); echo ($c["cat_name"]); ?></option><?php endforeach; endif; ?>
            <!-- <option value="11" >&nbsp;&nbsp;&nbsp;&nbsp;读卡器和内存卡</option> -->
            <!-- <option value="7" >&nbsp;&nbsp;&nbsp;&nbsp;充电器</option><option value="8" >&nbsp;&nbsp;&nbsp;&nbsp;耳机</option><option value="9" >&nbsp;&nbsp;&nbsp;&nbsp;电池</option><option value="1" >手机类型</option><option value="3" >&nbsp;&nbsp;&nbsp;&nbsp;GSM手机</option><option value="4" >&nbsp;&nbsp;&nbsp;&nbsp;3G手机</option><option value="5" >&nbsp;&nbsp;&nbsp;&nbsp;双模手机</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;CDMA手机</option><option value="12" >充值卡</option><option value="14" >&nbsp;&nbsp;&nbsp;&nbsp;移动手机充值卡</option><option value="15" >&nbsp;&nbsp;&nbsp;&nbsp;联通手机充值卡</option><option value="13" >&nbsp;&nbsp;&nbsp;&nbsp;小灵通/固话充值卡</option> -->
            </select>
             </td>
          </tr>
                   <tr>
