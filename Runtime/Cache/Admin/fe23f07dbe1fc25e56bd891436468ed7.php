...
<?php if(is_array($catlist)): foreach($catlist as $key=>$cat): ?><tr align="center" class="0" id="0_1" id = 'tr_15'>
    <td align="left" class="first-cell" style = 'padding-left="1"'>
            <img src="/Public/Admin/images/menu_minus.gif" id="icon_0_1" width="9" height="9" border="0" style="margin-left:<?php echo ($cat['lev']*2); ?>em" />
    ...
    <td width="24%" align="center">
      <a href="#">转移商品</a> |
      <a href="<?php echo U('admin/cat/catedit',array('catid'=>$cat['cat_id']));?>">编辑</a> |
      <a href="<?php echo U('admin/cat/catdel',array('catid'=>$cat['cat_id']));?>" title="移除">移除</a>
    </td>
