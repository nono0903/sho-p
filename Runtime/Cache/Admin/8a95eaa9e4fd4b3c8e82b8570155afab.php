...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <td>
          <select name="parent_id">
                        ...
                        <?php if(is_array($catlist)): foreach($catlist as $key=>$k): ?><option value="<?php echo ($k['cat_id']); ?>"><?php echo (str_repeat('&nbsp;',$k['lev']*2)); echo ($k['cat_name']); ?></option><?php endforeach; endif; ?>
      ...
      <!-- <tr>
        <td class="label">验证:</td>
        
        <td><input type="text" name="yzm" id="yzm" /><img src="<?php echo U('Admin/cat/yzm');?>" alt="" onclick = click() /></td>
      </tr>
...
<!-- <script>
    function click(){
      ...
      yzm.src = <?php echo U('Admin/cat/catadd');?>;
