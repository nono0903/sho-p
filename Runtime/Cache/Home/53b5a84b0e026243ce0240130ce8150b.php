...
<tbody><tr><td><a href="" target="_blank"><img src="/Public/Home/images/1370400501175025752.jpg" width="230" height="100" border="0"></a></td></tr>
    ...
    <div class="w230"> 	
<h1 class="mod2tit" style="background:url(themes/68ecshop_hechafre/Public/Home/images/sdgg.gif) repeat-x; height:27px; color:#000">销售排行</h1>
<div class="mod1 mod2 blank" id="topbox">
    ...
    <div class="w230"> 
<h1 class="mod2tit" style=" position:relative;background:url(themes/68ecshop_hechafre/Public/Home/images/sdgg.gif) repeat-x; height:27px; color:#000">品牌专卖<a href="./brand.php.htm" class="more"><font style="color:#000">全部品牌</font></a></h1>
...
-->
  ...
  <h1 style="background:url(themes/68ecshop_hechafre/Public/Home/images/sdgg.gif) repeat-x; height:27px; line-height:27px; padding-left:10px; font-size:14px; color:#000">发货查询</h1>
