...
<link href="/shop1/Public/Home/css/style.css" rel="stylesheet" type="text/css">
...
<div class="block1">
    ...
    <div class="site-bar">
    <?php if(cookie_chk() == 1): ?><font id="ECS_MEMBERZONE"> <?php echo (cookie('username')); ?>您好，欢迎光临本店！|<a href="<?php echo U('Home/User/logout');?>" style="color:#50884b">退出</a>
    <?php else: ?>
...
<div class="page-header clearfix">
  <div class="block1 clearfix" style="position:relative;">
    <div class="logo fl"><a href="./index.php.htm" title=""><img src="/shop1/Public/Home/images/logo.gif" width="311" height="55" alt=""></a></div>    
    <div class="btMap">
      <div class="search ">
...
<div style="position:relative; width:1190px; margin:0 auto;"><object width="1190" height="360"><img src="/shop1/Public/Home/images/banner.png" style='margin:0 0 0 250px;' alt="" />
</object>
...
<div class="cagegoryCon clearfix">
  <?php if(is_array($cats)): foreach($cats as $key=>$cat1): if($cat1[parent_id] == 0): ?><dl>
        <dt><a href="<?php echo U('Home/Cat/catall',array('cat_id'=>$cat1['cat_id']));?>"><?php echo ($cat1["cat_name"]); ?></a></dt>          
        <dd class="clearfix"> 
         <?php if(is_array($cats)): foreach($cats as $key=>$cat2): if($cat2['parent_id'] == $cat1['cat_id']): ?><p class=""><a href="<?php echo U('Home/Cat/cat',array('cat_id'=>$cat2['cat_id']));?>" title="" class="txtdot"><?php echo ($cat2['cat_name']); ?></a></p><?php endif; endforeach; endif; ?>     
        </dd>
...
<tbody><tr><td><a href="" target="_blank"><img src="/shop1/Public/Home/images/1370400501175025752.jpg" width="230" height="100" border="0"></a></td></tr>
</tbody></table></div> </div>
  
    <div class="w230"> 	
<h1 class="mod2tit" style="background:url(themes/68ecshop_hechafre/shop1/Public/Home/images/sdgg.gif) repeat-x; height:27px; color:#000">销售排行</h1>
<div class="mod1 mod2 blank" id="topbox">
	<span class="lb"></span><span class="rb"></span>
	 <ul id="top10">
         <?php if(is_array($top)): foreach($top as $key=>$gtop): ?><li>
			 <div class="first">
			  <div class="fl">
				<font style="color:#F00; font-weight:bold"></font> <a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$gtop['goods_id']));?>" title=""><?php echo ($gtop["goods_name"]); ?></a>
				</div>
				<div class="fr"><b class="f1">￥<?php echo ($gtop["market_price"]); ?></b></div>
			 </div>
			 <div class="last">
			  <a href=""><img src="/shop1/Public/Home/images/3_thumb_G_1368081034405.jpg" alt="" align="left"></a>
    ...
    <div class="w230"> 
<h1 class="mod2tit" style=" position:relative;background:url(themes/68ecshop_hechafre/shop1/Public/Home/images/sdgg.gif) repeat-x; height:27px; color:#000">品牌专卖<a href="./brand.php.htm" class="more"><font style="color:#000">全部品牌</font></a></h1>
<div class="mod1 mod2 blank brandboxs1">
	<span class="lb"></span><span class="rb"></span>
	<div class="brandsL clearfix">
		<a href=""><img src="/shop1/Public/Home/images/1240803062307572427.gif" alt="诺基亚 (7)"></a>
    <a href=""><img src="/shop1/Public/Home/images/1240802922410634065.gif" alt="摩托罗拉 (1)"></a>
    <a href=""><img src="/shop1/Public/Home/images/1240803144788047486.gif" alt="多普达 (1)"></a>
    <a href=""><img src="/shop1/Public/Home/images/1240803247838195732.gif" alt="飞利浦 (1)"></a>
    <a href=""><img src="/shop1/Public/Home/images/1240803352280856940.gif" alt="夏新 (1)"></a>
    <a href=""><img src="/shop1/Public/Home/images/1240803412367015368.gif" alt="三星 (2)"></a>
    <a href=""><img src="/shop1/Public/Home/images/1240803482283160654.gif" alt="索爱 (2)"></a>
	</div>
</div>
...
-->
  ...
  <h1 style="background:url(themes/68ecshop_hechafre/shop1/Public/Home/images/sdgg.gif) repeat-x; height:27px; line-height:27px; padding-left:10px; font-size:14px; color:#000">发货查询</h1>
...
<div class="recommendContent entry-content" id="show_hot_area">
    <?php if(is_array($hots)): foreach($hots as $key=>$hots): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$hots['goods_id']));?>"><img src="<?php echo ($hots["goods_img"]); ?>" alt="<?php echo ($hots["goods_name"]); ?>"></a></div>
			 <a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$hots['goods_id']));?>" title="<?php echo ($hots["goods_name"]); ?>"><?php echo ($hots["goods_name"]); ?></a><br>
...
<div class="recommendContent entry-content" id="show_best_area">
    <?php if(is_array($best)): foreach($best as $key=>$bestgoods): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$bestgoods['goods_id']));?>"><img src="<?php echo ($bestgoods["goods_img"]); ?>" alt=""></a></div>
			 <a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$bestgoods['goods_id']));?>" title=""><?php echo ($bestgoods["goods_name"]); ?></a><br>
              <font class="goodspice market">￥<?php echo ($bestgoods["market_price"]); ?>元</font>
			 			 <b class="f1">￥<?php echo ($bestgoods["shop_price"]); ?>元</b><br>			 
			</div><?php endforeach; endif; ?>
</div>  
    <div class="">
<div style=" clearfix">
...
<div class="recommendContent entry-content" id="show_new_area">
      <div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=5.htm"><img src="/shop1/Public/Home/images/5_thumb_G_1370338478388.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
			 <a href="./goods.php-id=5.htm" title="ECSHOP模板中心68ecshop.com测试商品">ECSHOP模板中心68ecs...</a><br>
              <font class="goodspice market">￥24元</font>
			 			 <b class="f1">￥20元</b><br>			 
			</div>
      <div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=3.htm"><img src="/shop1/Public/Home/images/3_thumb_G_1368081034405.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
			 <a href="./goods.php-id=3.htm" title="ECSHOP模板中心68ecshop.com测试商品">ECSHOP模板中心68ecs...</a><br>
              <font class="goodspice market">￥82元</font>
			 			 <b class="f1">￥68元</b><br>			 
			</div>
      <div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=7.htm"><img src="/shop1/Public/Home/images/7_thumb_G_1370338401919.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
      ...
      <div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=22.htm"><img src="/shop1/Public/Home/images/22_thumb_G_1370338695095.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
...
<div class="block tc" style=""> <img src="/shop1/Public/Home/images/serviceImg1.jpg"> </div>
