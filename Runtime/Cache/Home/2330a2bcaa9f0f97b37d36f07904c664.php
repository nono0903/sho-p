...
<div class="block1">
    ...
    <a href="<?php echo U('Home/User/reg');?>" style="color:#50884b">免费注册</a><?php endif; ?>
      ...
      <ul class="sitelinks">
        <li><a href=""></a><a href="" title="查看购物车">购物车有 <?php echo ($num); ?> 件</a></li>
...
<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
      ...
      <?php if(is_array($che)): foreach($che as $key=>$che): ?><tr>
			<td bgcolor="#ffffff">
				<a  target="_blank"><?php echo ($che["goods_name"]); ?></a>
			</td>
			<td bgcolor="#ffffff">颜色:黑色 <br></td>
						<td align="right" bgcolor="#ffffff">￥<?php echo ($che["shop_price"]); ?>元</td>
						<td class="price" align="right" bgcolor="#ffffff">￥<?php echo ($che["market_price"]); ?>元</td>
			<td align="right" bgcolor="#ffffff"><?php echo ($che["num"]); ?></td>
			<td class="price" align="right" bgcolor="#ffffff">￥<?php echo ($che['num']*$che['shop_price']); ?>元</td>
			</tr><?php endforeach; endif; ?>
      <a href="<?php echo U('Home/Flow/cle');?>">清空购物车</a>

			<tr>
			<td colspan="7" class="f1 f14b" style="text-align:right;" bgcolor="#ffffff">
						购物金额小计 ￥<?php echo ($money); ?>元，比市场价 ￥3612.00元 节省了 ￥602.00元 (17%)			</td>
			</tr>
			</tbody></table>
	<div class="goodsTitle clearfix" style="background:#f6f6f6; border:#E3E3E3 solid 1px; border-bottom:none;">
